...
# evaluate grid training
def evaluate_by_districts(url, url2, stride=2, encoder_length=72, decoder_length=24, forecast_factor=0, is_classify=False, confusion_title="", norm=True, is_grid=True, offset=48, agg=True):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-el", "--encoder_length", type=int, default=0)
    ...
    if args.task == 0:
        ...
        evaluate_by_districts(args.url, args.url2, pr.strides, encoder_length=args.encoder_length, decoder_length=args.time_lags, forecast_factor=args.forecast_factor, is_classify=args.classify, confusion_title=args.confusion, is_grid=bool(args.grid), offset=args.offset)
    elif args.task == 5:
